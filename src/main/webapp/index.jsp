                            ...
                            <div class="row justify-content-end">
                                <div class="col-lg-6 col-md-6">
                                    <div class="event_slider_content">
                                        <h5>뽀송Dream</h5>
                                        <h2>드라이클리닝</h2>
                                        <p>합리적인 가격의 드라이클리닝을 신속하게 제공해드립니다.
                                        </p>
                                        <form name="frm1" method="get" action="#">
                                        <p>지점선택</p>
                                        <select name="store" id="store" title="지점선택">
								            <option value="gangnam">강남</option>
								            <option value="seocho">서초</option>
								            <option value="dongjak">동작</option></select>
								        <br>
                                        <p>맡기실 드라이클리닝 메뉴를 선택해주세요!</p>
                                        <select name="dryMenu" id="dryMenu" title="메뉴선택">
								            <option value="suits">정장세트</option>
								            <option value="shirts">와이셔츠</option>
								            <option value="coat">코트</option></select>
								        <br>
								        <br>
                                        </form>
                                        <a href="#" class="btn_1">주문하기</a>
                                    </div>
                                </div>
                            </div>
                        </div>
